...
import (
	"github.com/Koubae/jabba-ai-chat-app/internal/chat-identity/infrastructure/database/models"
...
func TestUserCrud(t *testing.T) {
	...
	user := &models.User{ApplicationID: "application-integration-tests", Username: username, PasswordHash: HashedPassword}
	var id uint64
