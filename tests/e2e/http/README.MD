...
curl -X POST localhost:20002/api/v1/session/create -H "Authorization: Bearer $access_token" -d '{"application_id": "e2e-application-001", "session_id": "session_123", "name": "session-test"}'
